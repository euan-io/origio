package cn.zqsoft.boot.framework.ai.core.factory;
...
import cn.zqsoft.boot.framework.ai.config.OrigoAiAutoConfiguration;
import cn.zqsoft.boot.framework.ai.config.OrigoAiProperties;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            OrigoAiProperties.MidjourneyProperties properties = SpringUtil.getBean(OrigoAiProperties.class).getMidjourney();
    ...
    /**
     * 可参考 {@link OrigoAiAutoConfiguration#deepSeekChatModel(OrigoAiProperties)}
     */
    ...
    /**
     * 可参考 {@link OrigoAiAutoConfiguration#xingHuoChatClient(OrigoAiProperties)}
     */
