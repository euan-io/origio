...
import cn.zqsoft.boot.module.trade.controller.admin.brokerage.vo.record.BrokerageRecordPageReqVO;
import cn.zqsoft.boot.module.trade.controller.app.brokerage.vo.record.AppBrokerageProductPriceRespVO;
import cn.zqsoft.boot.module.trade.controller.app.brokerage.vo.user.AppBrokerageUserRankByPriceRespVO;
...
import cn.zqsoft.boot.module.trade.dal.mysql.brokerage.BrokerageRecordMapper;
...
import cn.zqsoft.boot.module.trade.service.brokerage.bo.UserBrokerageSummaryRespBO;
...
import static cn.zqsoft.boot.framework.common.util.collection.CollectionUtils.getMaxValue;
import static cn.zqsoft.boot.framework.common.util.collection.CollectionUtils.getMinValue;
import static cn.zqsoft.boot.framework.web.core.util.WebFrameworkUtils.getLoginUserId;
import static cn.zqsoft.boot.module.trade.enums.ErrorCodeConstants.BROKERAGE_WITHDRAW_USER_BALANCE_NOT_ENOUGH;
