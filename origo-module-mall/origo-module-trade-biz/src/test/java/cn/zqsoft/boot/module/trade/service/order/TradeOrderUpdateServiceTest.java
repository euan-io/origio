...
import cn.zqsoft.boot.module.member.api.user.MemberUserApi;
...
import cn.zqsoft.boot.module.product.api.sku.ProductSkuApi;
import cn.zqsoft.boot.module.product.api.spu.ProductSpuApi;
import cn.zqsoft.boot.module.promotion.api.coupon.CouponApi;
import cn.zqsoft.boot.module.system.api.notify.NotifyMessageSendApi;
...
import cn.zqsoft.boot.module.trade.enums.order.TradeOrderRefundStatusEnum;
import cn.zqsoft.boot.module.trade.enums.order.TradeOrderStatusEnum;
import cn.zqsoft.boot.module.trade.framework.order.config.TradeOrderConfig;
import cn.zqsoft.boot.module.trade.framework.order.config.TradeOrderProperties;
import cn.zqsoft.boot.module.trade.service.cart.CartServiceImpl;
import cn.zqsoft.boot.module.trade.service.delivery.DeliveryExpressService;
import cn.zqsoft.boot.module.trade.service.delivery.DeliveryExpressServiceImpl;
import cn.zqsoft.boot.module.trade.service.message.TradeMessageServiceImpl;
import cn.zqsoft.boot.module.trade.service.order.handler.TradeOrderHandler;
import cn.zqsoft.boot.module.trade.service.price.TradePriceServiceImpl;
import cn.zqsoft.boot.module.trade.service.price.calculator.TradePriceCalculator;
...
import static cn.zqsoft.boot.framework.test.core.util.RandomUtils.randomPojo;
