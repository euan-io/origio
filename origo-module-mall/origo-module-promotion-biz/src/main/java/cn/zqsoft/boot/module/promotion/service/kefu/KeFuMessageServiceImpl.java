package cn.zqsoft.boot.module.promotion.service.kefu;
...
import cn.zqsoft.boot.module.infra.api.websocket.WebSocketSenderApi;
import cn.zqsoft.boot.module.member.api.user.MemberUserApi;
import cn.zqsoft.boot.module.promotion.controller.admin.kefu.vo.message.KeFuMessagePageReqVO;
import cn.zqsoft.boot.module.promotion.controller.admin.kefu.vo.message.KeFuMessageSendReqVO;
...
import cn.zqsoft.boot.module.promotion.dal.dataobject.kefu.KeFuConversationDO;
import cn.zqsoft.boot.module.promotion.dal.dataobject.kefu.KeFuMessageDO;
import cn.zqsoft.boot.module.promotion.dal.mysql.kefu.KeFuMessageMapper;
...
import static cn.zqsoft.boot.module.promotion.enums.ErrorCodeConstants.KEFU_CONVERSATION_NOT_EXISTS;
import static cn.zqsoft.boot.module.promotion.enums.WebSocketMessageTypeConstants.KEFU_MESSAGE_ADMIN_READ;
import static cn.zqsoft.boot.module.promotion.enums.WebSocketMessageTypeConstants.KEFU_MESSAGE_TYPE;
