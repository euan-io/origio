package cn.zqsoft.boot.module.iot.emq.client;

import cn.zqsoft.boot.module.iot.emq.callback.EmqxCallback;
import cn.zqsoft.boot.module.iot.emq.config.MqttConfig;
import lombok.Data;
...
public class EmqxClient {
    ...
    private void createMqttClient() {
        try {
            mqttClient = new MqttClient(mqttConfig.getHostUrl(), "origo" + mqttConfig.getClientId(), new MemoryPersistence());
