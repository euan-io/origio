...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.zqsoft.boot";
    private static final String ARTIFACT_ID = "origo";
    private static final String PACKAGE_NAME = "cn.zqsoft.boot";
    private static final String TITLE = "原点基础框架";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.zqsoft.boot";
        String artifactIdNew = "origo";
        String packageNameNew = "cn.zqsoft.boot";
        String titleNew = "原点基础框架";
        String projectBaseDirNew = "origo"; // 一键改名后，“新”项目所在的目录
