package cn.zqsoft.boot.module.infra.framework.file.core.s3;
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.origo.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.origo.iocoder.cn
        // 默认上海的 endpoint
