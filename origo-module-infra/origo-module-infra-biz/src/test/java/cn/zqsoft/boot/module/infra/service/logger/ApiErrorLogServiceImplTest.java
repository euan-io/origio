package cn.zqsoft.boot.module.infra.service.logger;
...
import cn.zqsoft.boot.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.zqsoft.boot.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.zqsoft.boot.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.zqsoft.boot.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.zqsoft.boot.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.zqsoft.boot.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("origo-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("origo-test");
