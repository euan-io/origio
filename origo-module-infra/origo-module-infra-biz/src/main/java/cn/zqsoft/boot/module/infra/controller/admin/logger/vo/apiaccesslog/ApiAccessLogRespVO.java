package cn.zqsoft.boot.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(cn.zqsoft.boot.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
