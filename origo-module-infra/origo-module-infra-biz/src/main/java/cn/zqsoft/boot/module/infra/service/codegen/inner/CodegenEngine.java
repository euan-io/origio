package cn.zqsoft.boot.module.infra.service.codegen.inner;
...
import cn.zqsoft.boot.framework.apilog.core.enums.OperateTypeEnum;
...
import cn.zqsoft.boot.framework.excel.core.annotations.DictFormat;
import cn.zqsoft.boot.framework.excel.core.convert.DictConvert;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "origo-module-${table.moduleName}/" + // 顶级模块
                "origo-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "origo-module-${table.moduleName}/" + // 顶级模块
                "origo-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "origo-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "origo-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
