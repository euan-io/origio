package cn.zqsoft.boot.module.mp.service.account;
...
import cn.zqsoft.boot.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import cn.zqsoft.boot.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import cn.zqsoft.boot.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import cn.zqsoft.boot.module.mp.convert.account.MpAccountConvert;
import cn.zqsoft.boot.module.mp.dal.dataobject.account.MpAccountDO;
import cn.zqsoft.boot.module.mp.dal.mysql.account.MpAccountMapper;
import cn.zqsoft.boot.module.mp.enums.ErrorCodeConstants;
import cn.zqsoft.boot.module.mp.framework.mp.core.MpServiceFactory;
...
import static cn.zqsoft.boot.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 origo-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
