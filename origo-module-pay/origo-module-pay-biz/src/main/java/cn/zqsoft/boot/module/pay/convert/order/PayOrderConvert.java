package cn.zqsoft.boot.module.pay.convert.order;
...
import cn.zqsoft.boot.module.pay.controller.admin.order.vo.*;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, cn.zqsoft.boot.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
