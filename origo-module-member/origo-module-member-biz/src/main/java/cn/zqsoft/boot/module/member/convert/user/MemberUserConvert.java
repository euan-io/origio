package cn.zqsoft.boot.module.member.convert.user;

import cn.zqsoft.boot.framework.common.pojo.PageResult;
import cn.zqsoft.boot.module.member.api.user.dto.MemberUserRespDTO;
import cn.zqsoft.boot.module.member.controller.admin.user.vo.MemberUserRespVO;
import cn.zqsoft.boot.module.member.controller.admin.user.vo.MemberUserUpdateReqVO;
import cn.zqsoft.boot.module.member.controller.app.user.vo.AppMemberUserInfoRespVO;
