package cn.zqsoft.boot.module.member.controller.admin.config;

import cn.zqsoft.boot.framework.common.pojo.CommonResult;
import cn.zqsoft.boot.module.member.controller.admin.config.vo.MemberConfigRespVO;
import cn.zqsoft.boot.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import cn.zqsoft.boot.module.member.convert.config.MemberConfigConvert;
import cn.zqsoft.boot.module.member.dal.dataobject.config.MemberConfigDO;
import cn.zqsoft.boot.module.member.service.config.MemberConfigService;
