...
import cn.zqsoft.boot.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import cn.zqsoft.boot.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, OrigoRedisAutoConfiguration.class})
