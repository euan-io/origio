package cn.zqsoft.boot.module.system.service.user;
...
import cn.zqsoft.boot.module.infra.api.config.ConfigApi;
import cn.zqsoft.boot.module.infra.api.file.FileApi;
...
import cn.zqsoft.boot.module.system.controller.admin.user.vo.user.*;
...
import cn.zqsoft.boot.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.zqsoft.boot.module.system.enums.common.SexEnum;
...
import static cn.zqsoft.boot.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("origoyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("origoyuanma");
        ...
        assertEquals("origoyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("origoyuanma"))).thenReturn("java");
