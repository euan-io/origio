...
import cn.zqsoft.boot.framework.common.util.cache.CacheUtils;
import cn.zqsoft.boot.framework.common.util.http.HttpUtils;
import cn.zqsoft.boot.framework.common.util.object.BeanUtils;
import cn.zqsoft.boot.module.system.api.social.dto.SocialWxQrcodeReqDTO;
...
import cn.zqsoft.boot.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cn.zqsoft.boot.module.system.dal.dataobject.social.SocialClientDO;
import cn.zqsoft.boot.module.system.dal.mysql.social.SocialClientMapper;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${origo.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${origo.wxa-subscribe-message.miniprogram-state:formal}")
