package cn.zqsoft.boot.module.crm.controller.admin.customer.vo.customer;

import cn.zqsoft.boot.framework.common.validation.InEnum;
import cn.zqsoft.boot.framework.common.validation.Mobile;
import cn.zqsoft.boot.framework.common.validation.Telephone;
import cn.zqsoft.boot.framework.excel.core.annotations.DictFormat;
import cn.zqsoft.boot.module.crm.enums.customer.CrmCustomerLevelEnum;
import cn.zqsoft.boot.module.crm.framework.operatelog.core.CrmCustomerIndustryParseFunction;
import cn.zqsoft.boot.module.crm.framework.operatelog.core.CrmCustomerLevelParseFunction;
import cn.zqsoft.boot.module.crm.framework.operatelog.core.CrmCustomerSourceParseFunction;
import cn.zqsoft.boot.module.crm.framework.operatelog.core.SysAreaParseFunction;
...
import static cn.zqsoft.boot.framework.common.util.date.DateUtils.FORMAT_YEAR_MONTH_DAY_HOUR_MINUTE_SECOND;
import static cn.zqsoft.boot.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_INDUSTRY;
