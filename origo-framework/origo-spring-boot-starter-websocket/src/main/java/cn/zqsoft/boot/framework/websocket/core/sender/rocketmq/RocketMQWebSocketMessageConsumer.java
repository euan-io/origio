package cn.zqsoft.boot.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${origo.websocket.sender-rocketmq.topic}",
        consumerGroup = "${origo.websocket.sender-rocketmq.consumer-group}",
