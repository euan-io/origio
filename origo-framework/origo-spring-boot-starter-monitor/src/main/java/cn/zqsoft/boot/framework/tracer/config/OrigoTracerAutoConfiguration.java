...
import cn.zqsoft.boot.framework.tracer.core.aop.BizTraceAspect;
import cn.zqsoft.boot.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "origo.tracer", value = "enable", matchIfMissing = true)
public class OrigoTracerAutoConfiguration {
