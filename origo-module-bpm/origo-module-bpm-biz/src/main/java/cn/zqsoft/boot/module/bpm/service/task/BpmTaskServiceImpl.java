package cn.zqsoft.boot.module.bpm.service.task;
...
import cn.zqsoft.boot.framework.common.util.number.NumberUtils;
import cn.zqsoft.boot.framework.common.util.object.ObjectUtils;
import cn.zqsoft.boot.framework.common.util.object.PageUtils;
import cn.zqsoft.boot.framework.web.core.util.WebFrameworkUtils;
import cn.zqsoft.boot.module.bpm.controller.admin.task.vo.task.*;
import cn.zqsoft.boot.module.bpm.convert.task.BpmTaskConvert;
import cn.zqsoft.boot.module.bpm.enums.definition.*;
import cn.zqsoft.boot.module.bpm.enums.task.BpmCommentTypeEnum;
import cn.zqsoft.boot.module.bpm.enums.task.BpmReasonEnum;
import cn.zqsoft.boot.module.bpm.enums.task.BpmTaskSignTypeEnum;
import cn.zqsoft.boot.module.bpm.enums.task.BpmTaskStatusEnum;
import cn.zqsoft.boot.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import cn.zqsoft.boot.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import cn.zqsoft.boot.module.bpm.framework.flowable.core.util.FlowableUtils;
import cn.zqsoft.boot.module.bpm.service.definition.BpmModelService;
import cn.zqsoft.boot.module.bpm.service.message.BpmMessageService;
import cn.zqsoft.boot.module.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
...
import static cn.zqsoft.boot.module.bpm.enums.ErrorCodeConstants.*;
import static cn.zqsoft.boot.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_RETURN_FLAG;
...
public class BpmTaskServiceImpl implements BpmTaskService {
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        // 疑问：为什么要标记未通过呢？
        // 回答：例如说 A 任务被向前加签除 B 任务时，B 任务被审批不通过，此时 A 会被取消。而 origo-ui-admin-vue3 不展示“已取消”的任务，导致展示不出审批不通过的细节。
